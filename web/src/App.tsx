...
const VERSION = "1.3";
// 1.3 adds a nested risk panel (the asthma-maf shape) and the label-orientation
// demo group. Definitions are immutable, so it is a new row rather than an
// edit — publish it before switching:
